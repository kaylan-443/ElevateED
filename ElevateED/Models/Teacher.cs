...
namespace ElevateED.Models
{
    public class Teacher
    {
        ...
        public virtual ICollection<HomeworkSubmission> GradedHomeworkSubmissions { get; set; }
        public virtual ICollection<ClassworkSubmission> GradedClassworkSubmissions { get; set; }
        ...
        public Teacher()
        {
            ...
            GradedHomeworkSubmissions = new HashSet<HomeworkSubmission>();
            GradedClassworkSubmissions = new HashSet<ClassworkSubmission>();
